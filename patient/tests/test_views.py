...
#         print("Test test_project_list_GET Running!!")
#         response = PatientList.response()
#         #response = client.request.GET.get(reverse('list'))

#         self.assertEquals(response.status_code, 200)
#         self.assetTemplateUsed(response, '/patient/patient.html')
